                ...
                <GlassCard className="w-full relative overflow-hidden border border-white/20 shadow-2xl backdrop-blur-xl bg-white/5">
                    ...
                    <div className="relative z-10 p-2">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            >
                                <Mail className="absolute left-4 top-3.5 w-5 h-5 text-white/40 group-focus-within:text-blue-400 transition-colors duration-300" />
                                <input 
                                    required 
                                    name="email" 
                                    type="email" 
                            ...
                            <motion.div 
                                ...
                                className="relative group"
                            >
                                <Lock className="absolute left-4 top-3.5 w-5 h-5 text-white/40 group-focus-within:text-purple-400 transition-colors duration-300" />
                                <input 
                                    required 
                                    name="password" 
                                    type="password" 
